...
export declare class UTXOSet extends StandardUTXOSet<UTXO> {
     ...
     *
     */
    buildExportTx: (networkID: number, blockchainID: Buffer, amount: BN, axcAssetID: Buffer, toAddresses: Buffer[], fromAddresses: Buffer[], changeAddresses?: Buffer[], destinationChain?: Buffer, fee?: BN, feeAssetID?: Buffer, asOf?: BN, locktime?: BN, threshold?: number) => UnsignedTx;
}
